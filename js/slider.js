...
var sliderItem = document.querySelectorAll('.gw-slider-item');
...
var setActiveSlide = function () {
    for (var sld = 0; sld < sliderItem.length; sld++) {
        ...
        if (mySlideNum === currentCounter) {
            ...
            sliderItem[sld].querySelector('.gw-portfolio-item-box').classList.add('gw-scale-right');
            sliderItem[sld].querySelector('.gw-portfolio-item-thumb img').classList.add('gw-scale-up');
            sliderItem[sld].querySelector('.gw-portfolio-item-info').classList.add('gw-fade-from-left');
        }
    }
}
...
var changeActive = function () {
    ...
    for (var rms = 0; rms < sliderItem.length; rms++) {
        ...
        sliderItem[rms].querySelector('.gw-portfolio-item-box').classList.remove('gw-scale-right');
        sliderItem[rms].querySelector('.gw-portfolio-item-thumb img').classList.remove('gw-scale-up');
        sliderItem[rms].querySelector('.gw-portfolio-item-info').classList.remove('gw-fade-from-left');
    }
    setActiveNav();
    setActiveSlide();
}
